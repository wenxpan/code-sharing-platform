    ...
    <div>
      <div className="space-y-1 flex justify-between">
        <div className="flex flex-col justify-start">
          ...
          <p className="text-small text-default-400">See how others think of your projects</p>
        </div>
    ...
    <div>
      <div className="space-y-1 flex justify-between">
        <div className="flex flex-col justify-start">
          ...
          <p className="text-small text-default-400">Thanks for giving out ideas</p>
        </div>
        <Link className="flex justify-end" href="#">
          View All
        </Link>
...
const CoderDashboard: React.FC<CoderDashboardProps> = ({ params }) => {
  const id = params.id;
  try {
    const coder = coders.find((c) => c.id === parseInt(id));
    ...
    return (
      <article className="flex grid grid-cols-10 gap-4 pt-10">
